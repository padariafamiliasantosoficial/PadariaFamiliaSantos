...
const produtos = [
    ...
    { id: 2, nome: 'Pão de Sal', preco: 0.60, imagem: 'imagens/paodesal.jpg', descricao: 'O clássico pão de sal, crocante por fora e macio por dentro. Ideal para sanduíches ou para comer com manteiga no café da manhã.', categoria: 'Pães' },
    { id: 3, nome: 'Enroladinho de Salsicha', preco: 1.99, imagem: 'imagens/enroladinhodesalsicha.jpg', descricao: 'Saboroso enroladinho de salsicha, perfeito para um lanche rápido. Feito com massa leve e salsicha de qualidade.', categoria: 'Salgados' },
    { id: 4, nome: 'Bolo Bombocado', preco: 16.49, imagem: 'imagens/bolobombocado.jpg', descricao: 'Um bolo bombocado irresistível, com textura macia e sabor intenso de coco. Perfeito para sobremesa ou lanche da tarde.', categoria: 'Bolos' },
    { id: 5, nome: 'Bolo de Chocolate', preco: 19.99, imagem: 'imagens/bolodechocolate.jpg', descricao: 'Bolo de chocolate fofinho e delicioso, com cobertura cremosa de chocolate. Uma explosão de sabor para os amantes de chocolate.', categoria: 'Bolos' },
    { id: 6, nome: 'Pudim', preco: 4.99, imagem: 'imagens/pudim.jpg', descricao: 'Pudim cremoso com calda caramelizada, feito com leite condensado e ovos. Uma sobremesa clássica que derrete na boca.', categoria: 'Sobremesas' },
    { id: 7, nome: 'Rosca de Leite', preco: 2.50, imagem: 'imagens/rosquinhadeleite.jpg', descricao: 'Rosca de leite macia e saborosa, com leve toque de baunilha. Perfeita para acompanhar um café ou chá.', categoria: 'Pães' },
    { id: 8, nome: 'Pão de Doce', preco: 1.20, imagem: 'imagens/paodedoce.jpeg', descricao: 'Pão doce com um toque especial de canela e açúcar. Ideal para o café da manhã ou lanche da tarde.', categoria: 'Pães' },
    { id: 9, nome: 'Bolo de Cenoura', preco: 16.49, imagem: 'imagens/bolodecenoura.jpg', descricao: 'Bolo de cenoura macio com cobertura de chocolate. Um clássico brasileiro que combina o sabor da cenoura com o doce do chocolate.', categoria: 'Bolos' },
    { id: 10, nome: 'Bolo de Fubá', preco: 16.49, imagem: 'imagens/bolodefuba.jpg', descricao: 'Bolo de fubá tradicional, com textura leve e sabor suave de milho. Perfeito para acompanhar um café fresquinho.', categoria: 'Bolos' },
    { id: 11, nome: 'Bolo de Milho', preco: 16.49, imagem: 'imagens/bolodemilho.jpg', descricao: 'Bolo de milho cremoso, feito com milho verde fresco. Uma delícia típica das festas juninas, mas gostosa o ano todo.', categoria: 'Bolos' },
    { id: 12, nome: 'Bolo de Trigo', preco: 16.49, imagem: 'imagens/bolodetrigo.jpg', descricao: 'Bolo de trigo simples e delicioso, com sabor caseiro. Ideal para quem gosta de um bolo fofinho e sem muita cobertura.', categoria: 'Bolos' },
    { id: 13, nome: 'Bolo de Mandioca', preco: 16.49, imagem: 'imagens/bolodemandioca.jpg', descricao: 'Bolo de mandioca com textura única e sabor marcante. Feito com mandioca fresca e coco ralado.', categoria: 'Bolos' },
    { id: 14, nome: 'Bolo de Laranja', preco: 16.99, imagem: 'imagens/bolodelaranja.jpg', descricao: 'Bolo de laranja fofinho e cítrico, com cobertura de glacê de laranja. Perfeito para um lanche refrescante.', categoria: 'Bolos' },
    { id: 15, nome: 'Bolo de Chocolate', preco: 20.99, imagem: 'imagens/bolodechocolate2-1.jpg', descricao: 'Bolo de chocolate, ainda mais irresistível, cobertura e recheio de chocolate.', categoria: 'Bolos' },
    { id: 16, nome: 'Bolo de Coco', preco: 17.99, imagem: 'imagens/bolodecoco.jpg', descricao: 'Bolo de coco úmido e saboroso, com cobertura de coco ralado. Uma explosão de sabor tropical.', categoria: 'Bolos' },
    { id: 17, nome: 'Bolo de Formigueiro', preco: 16.49, imagem: 'imagens/boloformigueiro.jpeg', descricao: 'Bolo de formigueiro com granulado, perfeito para festas e lanches. O contraste do granulado com a massa fofinha é irresistível.', categoria: 'Bolos' },
    { id: 18, nome: 'Bolo de Banana', preco: 16.99, imagem: 'imagens/bolodebanana.jpg', descricao: 'Bolo de banana com um toque caseiro, feito com bananas maduras e canela. Perfeito para aproveitar bananas que estão sobrando.', categoria: 'Bolos' },
    { id: 19, nome: 'Bolo de Leite Ninho', preco: 16.49, imagem: 'imagens/bolodeleiteninho.jpg', descricao: 'Bolo de leite ninho cremoso, com recheio e cobertura de creme de leite ninho. Uma sobremesa sofisticada e deliciosa.', categoria: 'Bolos' },
    { id: 20, nome: 'Mousse de Maracujá', preco: 3.50, imagem: 'imagens/moussedemaracuja.jpg', descricao: 'Mousse leve e refrescante com sabor intenso de maracujá. Perfeito para dias quentes ou como sobremesa após uma refeição.', categoria: 'Sobremesas' },
    { id: 21, nome: 'Pão Integral', preco: 8.99, imagem: 'imagens/paointegral.jpg', descricao: 'Pão rico em fibras, perfeito para uma alimentação saudável. Feito com farinha integral e grãos.', categoria: 'Pães' },
    { id: 22, nome: 'Pão de Forma', preco: 11.49, imagem: 'imagens/paodeforma.jpg', descricao: 'Pão fatiado, macio e versátil para sanduíches e torradas. Ideal para o café da manhã ou lanches rápidos.', categoria: 'Pães' },
    { id: 23, nome: 'Cajuzinho', preco: 1.50, imagem: 'imagens/cajuzinho.jpg', descricao: 'Doce de amendoim com toque de chocolate, coberto com granulado. Um clássico das festas brasileiras.', categoria: 'Sobremesas' },
    { id: 24, nome: 'Torta de Morango', preco: 6.00, imagem: 'imagens/tortademorango.jpg', descricao: 'Torta com creme de baunilha e morangos frescos, coberta com geleia de morango. Uma sobremesa leve e deliciosa.', categoria: 'Sobremesas' },
    { id: 25, nome: 'Pão de Milho', preco: 2.50, imagem: 'imagens/paodemilho.jpg', descricao: 'Pão leve com sabor rústico de milho, ótimo para lanches. Feito com fubá e milho verde.', categoria: 'Pães' },
    { id: 26, nome: 'Pão de Centeio', preco: 3.00, imagem: 'imagens/paocenteio.jpg', descricao: 'Pão denso e nutritivo, com sabor marcante de centeio. Ideal para sanduíches mais robustos.', categoria: 'Pães' },
    { id: 27, nome: 'Pão Ciabatta', preco: 4.00, imagem: 'imagens/paociabatta.jpg', descricao: 'Pão italiano com casca crocante e miolo aerado, perfeito para bruschettas ou sanduíches gourmet.', categoria: 'Pães' },
    { id: 28, nome: 'Pão de Leite', preco: 1.80, imagem: 'imagens/paodeleite.jpg', descricao: 'Pão macio e levemente doce, ideal para lanches infantis ou para comer com geleia.', categoria: 'Pães' },
    { id: 29, nome: 'Cheesecake', preco: 7.00, imagem: 'imagens/cheesecake.jpg', descricao: 'Torta cremosa de queijo com base de biscoito e cobertura de frutas vermelhas. Uma sobremesa sofisticada e irresistível.', categoria: 'Sobremesas' },
    { id: 30, nome: 'Esfiha de Carne', preco: 3.00, imagem: 'imagens/esfiha.jpg', descricao: 'Esfiha recheada com carne moída temperada, suculenta e saborosa. Perfeita para um lanche rápido.', categoria: 'Salgados' },
    { id: 31, nome: 'Coxinha de Frango', preco: 3.50, imagem: 'imagens/coxinhadefrango.jpg', descricao: 'Coxinha crocante com recheio cremoso de frango desfiado. Um clássico das padarias brasileiras.', categoria: 'Salgados' },
    { id: 32, nome: 'Empada de Palmito', preco: 3.20, imagem: 'imagens/empada.jpg', descricao: 'Empada com massa amanteigada e recheio cremoso de palmito. Uma opção vegetariana deliciosa.', categoria: 'Salgados' },
    { id: 33, nome: 'Beijinho', preco: 1.50, imagem: 'imagens/beijinho.jpg', descricao: 'Doce de coco com toque de leite condensado, coberto com coco ralado. Um docinho tradicional e irresistível.', categoria: 'Sobremesas' },
    { id: 34, nome: 'Quibe Frito', preco: 3.00, imagem: 'imagens/quibefrito.jpg', descricao: 'Quibe crocante com recheio de carne moída e especiarias. Perfeito para um lanche ou aperitivo.', categoria: 'Salgados' },
    { id: 35, nome: 'Folhado de Frango', preco: 3.50, imagem: 'imagens/folhadefrango.jpg', descricao: 'Massa folhada com recheio cremoso de frango e catupiry. Uma combinação irresistível de sabores.', categoria: 'Salgados' },
    { id: 36, nome: 'Pudim de Leite', preco: 5.00, imagem: 'imagens/pudimdeleite.jpg', descricao: 'Pudim cremoso com calda de caramelo, clássico e irresistível. Feito com leite condensado, ovos e baunilha.', categoria: 'Sobremesas' }
];
